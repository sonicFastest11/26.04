...
public class Seller {
	...
	public Seller(@AttrRef("fullName") String fullName, @AttrRef("dob") String dob,
	...
	public Seller(@AttrRef("id") String id, @AttrRef("fullName") String fullName, @AttrRef("dob") String dob,
