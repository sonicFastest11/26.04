...
public class Supplier {
	...
	@DAttr(name = "supplierName", type = Type.String, length = 30, optional = false)
	private String supplierName;

	@DAttr(name = "phone", type = Type.String, length = 15, optional = false)
	...
	public String toString() {
		return "Importer(" + id + "," + supplierName + "," + phone + "," + address + "," + email + ")";
	}
