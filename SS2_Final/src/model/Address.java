...
public class Address {
	...
	public Address(@AttrRef("street") String street,@AttrRef("district") String district,@AttrRef("cityName") String cityName) {
	...
	public Address(Integer id, String street,String district,String cityName) {
		this.id = nextId(id);
		this.street = street;
